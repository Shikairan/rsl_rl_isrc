...
#
"""PPO（近端策略优化）：GAE 优势、裁剪 surrogate、多轮小批量策略/价值更新。"""
...
class PPO:
    """PPO 算法内核：维护 ``RolloutStorage``、计算回报与优势、执行多轮 clipped surrogate 更新。"""
    ...
    def __init__(self,
        ...
        self.learning_rate = learning_rate #* self.world_size
        ...
        #    self.actor_critic = DDP(self.actor_critic, device_ids=[self.local_rank], find_unused_parameters=False)
    ...
    def act(self, obs, critic_obs):
        ...
        #if True:#isinstance(ActorCriticRecurrent, self.actor_critic)
    ...
    def update(self):
        ...
        for obs_batch, critic_obs_batch, actions_batch, target_values_batch, advantages_batch, returns_batch, old_actions_log_prob_batch, \
            old_mu_batch, old_sigma_batch, hid_states_batch, masks_batch in generator:
                ...
                step += 1
                #print("PPO:", obs_batch.shape, masks_batch.shape)
                ...
                #print("value_batch:", value_batch.shape)
                #print("mu_batch:", mu_batch.shape)
                #print("sigma_batch:",sigma_batch.shape)
