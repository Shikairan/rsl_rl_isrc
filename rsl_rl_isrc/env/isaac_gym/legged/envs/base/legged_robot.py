from rsl_rl_isrc.env.isaac_gym.legged import LEGGED_GYM_ROOT_DIR
import time
...
class LeggedRobot(BaseTask):
    ...
    def _init_buffers(self):
        ...
        #print("self.torques", self.torques, self.torques.shape)
    ...
    def _create_envs(self):
        ...
        methods = [method for method in dir(self.gym) if callable(getattr(self.gym, method)) and not method.startswith("__")]
